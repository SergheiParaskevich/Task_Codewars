...
// function repeatString(str, num, separating){
//     const arr = [];
//     for(let i = 0; i < num; i++){
//         arr.push(str)
//     }
//     return  arr.join(separating)
// }
...
//     let strTooArr = word.split("").slice(0, newStr.length)
//  return (JSON.stringify(newStr) == JSON.stringify(strTooArr))
// }
// console.log(checkStart('sasas' , 'sas'));
...
// let newStr = str.split('').slice(0, num).join('')+`${'...'}`
// return newStr
